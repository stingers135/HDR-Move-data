...
GLOBAL_ANIMS = {
    ...
    'c01attacks3s3',        # ftilt3 (Meta Knight third hit)
    'c02attackhi3',         # utilt
    'c02attacklw3',         # dtilt
...
CHARACTER_SPECIFIC_ANIMS = {
    ...
    # Mega Man: uses non-standard slot prefixes for some moves
    'rockman': {
        'c02attacks3s',         # ftilt (normally c01)
        'c05attackairnmelee',   # nair melee (normally c05attackairn)
    },
}
